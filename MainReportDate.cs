...
{
    public partial class MainReportDate : Form
    {
        public MainReportDate()
        {
            InitializeComponent();
        }
        ...
        private void bntSearch_Click(object sender, EventArgs e)
        {
            ...
            crReportDocument.Load(Application.StartupPath + "\\Report\\ReportPODate.rpt");
        ...
        private void MainReportDate_Load(object sender, EventArgs e)
        {
