...
{
    public partial class ReportBatch : Form
    {
        public ReportBatch()
        {
            InitializeComponent();
        ...
        private void ReportBatch_Load(object sender, EventArgs e)
        {
            ReportDocument crReportDocument = new ReportDocument();
            crReportDocument.Load(Application.StartupPath + "\\Report2Bin\\Batch.rpt");
