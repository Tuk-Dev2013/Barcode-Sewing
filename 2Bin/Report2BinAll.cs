...
{
    public partial class Report2BinAll : Form
    {
        public Report2BinAll()
        {
            InitializeComponent();
        }

        private void Report2BinAll_Load(object sender, EventArgs e)
        {
            ReportDocument crReportDocument = new ReportDocument();
            crReportDocument.Load(Application.StartupPath + "\\Report2Bin\\2BinAll.rpt");
