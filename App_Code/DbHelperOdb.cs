...
namespace DatabaseHelperOdb
{
    ...
    public class DbHelperOdb:IDisposable
    {
        ...
        public DbHelperOdb(string connectionstring,Providers provider)
        {
            ...
            switch (provider)
            {
                ...
                case Providers.ConfigDefined:
                    string providername = ConfigurationManager.ConnectionStrings["DBEXPORTConnectionString"].ProviderName;
                    switch (providername)
                    {
        ...
        public DbHelperOdb(Providers provider)
            : this(ConfigurationManager.ConnectionStrings["DBEXPORTConnectionString"].ConnectionString, provider)
        {
        }

        public DbHelperOdb()
            : this(ConfigurationManager.ConnectionStrings["DBEXPORTConnectionString"].ConnectionString, Providers.ConfigDefined)
        {
        }
