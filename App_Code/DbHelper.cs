...
namespace DatabaseHelper
{
    ...
    public class DbHelper:IDisposable
    {
        ...
        public DbHelper(string connectionstring,Providers provider)
        {
            ...
            switch (provider)
            {
                ...
                case Providers.ConfigDefined:
                    string providername = ConfigurationManager.ConnectionStrings["DBBarcode"].ProviderName;
                    switch (providername)
                    {
        ...
        public DbHelper(Providers provider)
            : this(ConfigurationManager.ConnectionStrings["DBBarcode"].ConnectionString, provider)
        {
        }

        public DbHelper()
            : this(ConfigurationManager.ConnectionStrings["DBBarcode"].ConnectionString, Providers.ConfigDefined)
        {
        }
