...
{
    public partial class MainReportMessage : Form
    {
        public MainReportMessage()
        {
            InitializeComponent();
        }
        ...
        private void bntSearch_Click(object sender, EventArgs e)
        {
            ...
            crReportDocument.Load(Application.StartupPath + "\\Report\\ReportMessage.rpt");
            ...
            string startDate = sdate + " 06:10:17.000";
            string EndtDate = edate + " 23:10:17.000";
