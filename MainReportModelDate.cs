...
{
    public partial class MainReportModelDate : Form
    {
        public MainReportModelDate()
        {
            InitializeComponent();
        }
        ...
        private void bntSearch_Click(object sender, EventArgs e)
        {
            ...
            crReportDocument.Load(Application.StartupPath + "\\Report\\ReportModelDate.rpt");
        ...
        private void MainReportModelDate_Load(object sender, EventArgs e)
        {
