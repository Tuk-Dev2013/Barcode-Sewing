...
{
    public partial class FrmShowSchedule : Form
    {
        ...
        private void CallCellT(String tmpCell, String tmpremark)
        {
            ...
            try
            {
                ...
                if (ds.Tables["Showdata"].Rows.Count != 0)
                {
                    ...
                    {
                        bntAsemble3.BackColor = Color.Lime;
                    }
                    else if ((tmpremark == "2") && (tmpCell == "CELL3"))
                    {
                        bntpressing3.BackColor = Color.Lime;
                    }
            ...
            try
            {
                ...
                if (ds.Tables["showPoly"].Rows.Count != 0)
                {
                    ...
                    else if ((tmpremark == "Roding") && (tmpCell == "CELL2"))
                    {
                      ...
                      //Cell 3
                    else if ((tmpremark == "Poly") && (tmpCell == "CELL3"))
                    {
                        bntpoly3.BackColor = Color.Lime;
                    }
                    else if ((tmpremark == "Frame") && (tmpCell == "CELL3"))
                    {
                        bntFrame3.BackColor = Color.Lime;
                    }
                    else if ((tmpremark == "Roding") && (tmpCell == "CELL3"))
                    {
                        bntRod3.BackColor = Color.Lime;
                    }
                ...
                else
                {
                    ...
                    {
                        bntpoly3.BackColor = Color.Fuchsia;
                    }
                    else if ((tmpremark == "Frame") && (tmpCell == "CELL3"))
                    {
                        bntFrame3.BackColor = Color.Turquoise;
                    }
                    else if ((tmpremark == "Roding") && (tmpCell == "CELL3"))
                    {
                        bntRod3.BackColor = Color.BlueViolet;
                    }
                }
                conn.Close();
            }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
          ...
          //  this.lbldate.Text = DateTime.Now.ToString("dd/MM/yyyy", new System.Globalization.CultureInfo("en-US"));
           ...
           //   วิ่งหาข้อมูลแสดง
            ...
            CallCellCheck("CELL3", "Poly"); //Poly
            CallCellCheck("CELL3", "Frame"); //Frame
            CallCellCheck("CELL3", "Roding"); //Roding
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (c32.BackColor == Color.Red)
            {
                c32.BackColor = Color.DarkGray;
            }
            ...
            if (bntpoly3.BackColor == Color.Fuchsia)
            {
            ...
            if (bntFrame3.BackColor == Color.Turquoise)
            {
            ...
            if (bntRod3.BackColor == Color.BlueViolet)
            {
